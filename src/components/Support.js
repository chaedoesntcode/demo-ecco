...
const Support = () => {
  return (
    <div className='mt-10 grid grid-cols-1 md:grid-cols-3  md:gap-4 w-full'>
        <div className='p-10 hover:cursor-pointer hover:border hover:border-black transition text-center flex flex-col items-center'>
